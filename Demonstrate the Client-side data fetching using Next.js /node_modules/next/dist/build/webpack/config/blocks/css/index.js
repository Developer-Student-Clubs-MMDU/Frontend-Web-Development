...
var _fontLoader = require("./loaders/font-loader");
            ...
            oneOf: [
                markRemovable({
                    ...
                    use: {
                        loader: "error-loader",
                        options: {
                            reason: (0, _messages).getFontLoaderDocumentImportError()
                        }
                    }
                }), 
            ]
        ...
        fns.push((0, _helpers).loader({
            oneOf: [
                markRemovable({
                    ...
                    use: (0, _fontLoader).getFontLoader(ctx, lazyPostCSSInitializer, fontLoaderOptions)
                }), 
            ]
        }));
        fns.push((0, _helpers).loader({
            oneOf: [
                markRemovable({
                    ...
                    use: {
                        loader: "error-loader",
                        options: {
                            reason: (0, _messages).getFontLoaderImportError()
                        }
                    }
                }), 
            ]
