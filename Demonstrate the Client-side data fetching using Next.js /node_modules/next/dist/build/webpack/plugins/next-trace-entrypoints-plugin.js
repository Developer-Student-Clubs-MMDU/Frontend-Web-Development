...
class TraceEntryPointsPlugin {
    chunksToTrace = [];
    constructor({ appDir , appDirEnabled , excludeFiles , esmExternals , outputFileTracingRoot , turbotrace  }){
        this.appDir = appDir;
                ...
                if (this.turbotrace) {
                    ...
                    if (!(binding == null ? void 0 : binding.isWasm) && typeof binding.turbo.startTrace === "function") {
                        await finishModulesSpan.traceChild("turbo-trace", {
                            ...
                            const filesTracedInEntries = await binding.turbo.startTrace({
                                action: "print",
                                input: entriesToTrace,
                                contextDirectory,
                                processCwd: ((ref1 = this.turbotrace) == null ? void 0 : ref1.processCwd) ?? this.appDir
                            });
                    ...
                    entryPaths.forEach((entry)=>{
                        ...
                        if (curExtraEntries) {
                            for (const extraEntry of curExtraEntries.keys()){
                                ...
                                (ref2 = parentFilesMap.get(normalizedExtraEntry)) == null ? void 0 : ref2.forEach((dep)=>{
                                    finalDeps.add(_path.default.join(this.tracingRoot, dep));
                                });
                            }
                        }
                ...
                await turbotraceAfterEmitSpan.traceAsyncFn(async ()=>{
                    ...
                    if (!(binding == null ? void 0 : binding.isWasm) && typeof binding.turbo.startTrace === "function") {
                        ...
                        await binding.turbo.startTrace({
                            ...
                            contextDirectory: ((ref = this.turbotrace) == null ? void 0 : ref.contextDirectory) ?? this.tracingRoot,
                            processCwd: ((ref3 = this.turbotrace) == null ? void 0 : ref3.processCwd) ?? this.appDir
                        });
