...
export function getDefineEnv({ dev , config , distDir , isClient , hasRewrites , hasReactRoot , isNodeServer , isEdgeServer , middlewareMatchers  }) {
    var ref, ref1, ref2;
    return {
...
export default async function getBaseWebpackConfig(dir, { buildId , config , compilerType , dev =false , entrypoints , hasReactRoot , isDevFallback =false , pagesDir , reactProductionProfiling =false , rewrites , runWebpackSpan , target =COMPILER_NAMES.server , appDir , middlewareMatchers  }) {
    var ref45, ref4, ref5, ref6, ref7, ref8, ref9, ref10, ref11, ref12, // allows add JsConfigPathsPlugin to allow hot-reloading
    // if the config is added/removed
    ref13, ref14, ref15, ref16, ref17, ref18, ref19, ref20, ref21, ref22, ref23, ref24, ref25;
    ...
    if (useSWCLoader) {
        ...
        const binaryTarget = (ref26 = require("./swc")) == null ? void 0 : ref26.getBinaryMetadata == null ? void 0 : (ref27 = ref26.getBinaryMetadata()) == null ? void 0 : ref27.target;
    ...
    if (babelConfigFile && config.experimental.fontLoaders) {
        Log.error(`"experimental.fontLoaders" is enabled which requires SWC although Babel is being used due to custom babel config being present "${path.relative(dir, babelConfigFile)}".\nSee more info here: https://nextjs.org/docs/messages/babel-font-loader-conflict`);
        process.exit(1);
    }
    ...
    const getSwcLoader = (extraOptions)=>{
        ...
        if ((config == null ? void 0 : (ref = config.experimental) == null ? void 0 : ref.swcTraceProfiling) && !swcTraceProfilingInitialized) {
            ...
            (ref44 = require("./swc")) == null ? void 0 : ref44.initCustomTraceSubscriber == null ? void 0 : ref44.initCustomTraceSubscriber(path.join(distDir, `swc-trace-profile-${Date.now()}.json`));
        }
        return {
    ...
    const resolveConfig = {
        ...
        alias: {
            ...
            ...isEdgeServer ? {
                ...
                "next/dist/shared/lib/app-router-context": path.join(__dirname, "../dist/shared/lib/app-router-context.js"),
                "next/dist/client/components": path.join(__dirname, "../client/components"),
    ...
    const looseEsmExternals = ((ref45 = config.experimental) == null ? void 0 : ref45.esmExternals) === "loose";
    ...
    async function handleExternals(context, request, dependencyType, layer, getResolve) {
        ...
        const isLocalCallback = (localRes)=>{
            ...
            layer === WEBPACK_LAYERS.server ? false : /next[/\\]dist[/\\](shared|server)[/\\](?!lib[/\\](router[/\\]router|dynamic))/.test(localRes);
            if (isNextExternal) {
    ...
    let webpackConfig = {
        ...
        optimization: {
            ...
            splitChunks: (()=>{
                ...
                return {
                    ...
                    chunks: (chunk)=>!/^(polyfills|main|main-app|pages\/_app)$/.test(chunk.name),
                    cacheGroups: {
                        framework: {
                            chunks: (chunk)=>{
                                const name = chunk.name;
                                // Skip app directory and include shared modules in main-app.
                                if (name && hasAppDir && (name === "main-app" || name === "app-internals" || name.startsWith("app/"))) {
                                    return false;
                                }
                                return true;
                            },
                    ...
                    new TerserPlugin({
                        ...
                        terserOptions: {
                            ...
                            mangle: {
                                ...
                                ...((ref46 = config.experimental.swcMinifyDebugOptions) == null ? void 0 : ref46.mangle) ?? {}
                            }
                        }
                    }).apply(compiler);
                },
                ...
                ...hasServerComponents ? [
                    {
                        test: codeCondition.test,
                        issuerLayer (layer) {
                            return layer === WEBPACK_LAYERS.client || layer === WEBPACK_LAYERS.server;
                        },
                        resolve: {
                            alias: {
                                // Alias `next/dynamic` to React.lazy implementation for RSC
        ...
        plugins: [
            ...
            isClient && new ReactLoadablePlugin({
                ...
                pagesDir,
                runtimeAsset: hasConcurrentFeatures ? `server/${MIDDLEWARE_REACT_LOADABLE_MANIFEST}.js` : undefined,
                dev
            }),
    ...
    if (resolvedBaseUrl) {
        var ref28, ref29;
        (ref28 = webpackConfig.resolve) == null ? void 0 : (ref29 = ref28.modules) == null ? void 0 : ref29.push(resolvedBaseUrl);
    }
    ...
    if (isEdgeServer) {
        var ref30, ref31, ref32, ref33, ref34, ref35;
        ...
        (ref32 = webpack5Config.module) == null ? void 0 : (ref33 = ref32.rules) == null ? void 0 : ref33.unshift({
            dependency: "url",
            loader: "next-middleware-asset-loader",
            type: "javascript/auto",
            layer: WEBPACK_LAYERS.edgeAsset
        });
        (ref34 = webpack5Config.module) == null ? void 0 : (ref35 = ref34.rules) == null ? void 0 : ref35.unshift({
    ...
    const configVars = JSON.stringify({
        ...
        modularizeImports: (ref21 = config.experimental) == null ? void 0 : ref21.modularizeImports,
        legacyBrowsers: (ref22 = config.experimental) == null ? void 0 : ref22.legacyBrowsers
    });
    const cache = {
        type: "filesystem",
        // Includes:
    ...
    if (typeof config.webpack === "function") {
        ...
        if (((ref36 = webpack5Config.experiments) == null ? void 0 : ref36.lazyCompilation) === true) {
            webpack5Config.experiments.lazyCompilation = {
                entries: false
            };
        } else if (typeof ((ref37 = webpack5Config.experiments) == null ? void 0 : ref37.lazyCompilation) === "object" && webpack5Config.experiments.lazyCompilation.entries !== false) {
    ...
    if (!config.images.disableStaticImages) {
        var ref38;
        const rules = ((ref38 = webpackConfig.module) == null ? void 0 : ref38.rules) || [];
    ...
    if (config.experimental.craCompat && ((ref23 = webpackConfig.module) == null ? void 0 : ref23.rules) && webpackConfig.plugins) {
    ...
    const hasUserCssConfig = ((ref24 = webpackConfig.module) == null ? void 0 : (ref25 = ref24.rules) == null ? void 0 : ref25.some((rule)=>canMatchCss(rule.test) || canMatchCss(rule.include))) ?? false;
    if (hasUserCssConfig) {
        var ref39, ref40, ref41, ref42, ref43;
        ...
        if ((ref39 = webpackConfig.module) == null ? void 0 : (ref40 = ref39.rules) == null ? void 0 : ref40.length) {
        ...
        if ((ref41 = webpackConfig.plugins) == null ? void 0 : ref41.length) {
            // Disable CSS Extraction Plugin
            webpackConfig.plugins = webpackConfig.plugins.filter((p)=>p.__next_css_remove !== true);
        }
        if ((ref42 = webpackConfig.optimization) == null ? void 0 : (ref43 = ref42.minimizer) == null ? void 0 : ref43.length) {
