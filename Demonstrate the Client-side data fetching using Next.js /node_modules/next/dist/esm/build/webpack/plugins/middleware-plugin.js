...
function getCreateAssets(params) {
    ...
    return (assets)=>{
        ...
        for (const entrypoint of compilation.entrypoints.values()){
            ...
            const matchers = (metadata == null ? void 0 : (ref3 = metadata.edgeMiddleware) == null ? void 0 : ref3.matchers) ?? [
                {
                    regexp: namedRegex
                }, 
            ];
...
function isInMiddlewareFile(parser) {
    var ref, ref4;
    return ((ref = parser.state.current) == null ? void 0 : ref.layer) === "middleware" && /middleware\.\w+$/.test((ref4 = parser.state.current) == null ? void 0 : ref4.rawRequest);
}
