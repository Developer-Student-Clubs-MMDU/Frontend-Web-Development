...
import { LayoutRouterContext, GlobalLayoutRouterContext, TemplateContext, AppRouterContext } from '../../shared/lib/app-router-context';
...
path , rootLayoutIncluded  }) {
    const { changeByServerResponse , tree: fullTree , focusAndScrollRef ,  } = useContext(GlobalLayoutRouterContext);
 ...
 */ export default function OuterLayoutRouter({ parallelRouterKey , segmentPath , childProp , error , loading , hasLoading , template , notFound , rootLayoutIncluded  }) {
