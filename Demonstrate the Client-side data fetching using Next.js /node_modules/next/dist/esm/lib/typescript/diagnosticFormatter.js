        ...
        switch(message.code){
            ...
            case 2345:
                ...
                if (filepathAndInvalidExport) {
                    const main = `${type} "${chalk.bold(relativeSourceFile)}" exports invalid field "${chalk.bold(filepathAndInvalidExport[2])}". Only "default" and other configuration exports are allowed.`;
                    return main;
                }
                break;
            default:
