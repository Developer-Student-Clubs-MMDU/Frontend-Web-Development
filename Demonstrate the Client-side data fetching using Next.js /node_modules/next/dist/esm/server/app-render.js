...
class ReadonlyNextCookies {
    constructor(request){
        ...
        const cookiesInstance = new NextCookies(request);
 ...
 */ function createErrorHandler(/**
   ...
   */ _source, capturedErrors, allCapturedErrors) {
    return (err)=>{
        ...
        if (err.digest === DYNAMIC_ERROR_CODE || err.digest === NOT_FOUND_ERROR_CODE || ((ref = err.digest) == null ? void 0 : ref.startsWith(REDIRECT_ERROR_CODE))) {
            return err.digest;
        }
...
export async function renderToHTMLOrFlight(req, res, pathname, query, renderOpts) {
   ...
   */ const isStaticGeneration = renderOpts.supportsDynamicHTML !== true && !renderOpts.isBot;
     ...
     */ const createComponentTree = async ({ createSegmentPath , loaderTree: [segment, parallelRoutes, { layoutOrPagePath , layout , template , error , loading , page , "not-found": notFound ,  }, ] , parentParams , firstItem , rootLayoutIncluded  })=>{
            ...
            const Template = template ? await interopDefault(template()) : React.Fragment;
       ...
       */ const rootLayoutIncludedAtThisLevelOrAbove = rootLayoutIncluded || rootLayoutAtThisLevel;
            const NotFound = notFound ? await interopDefault(notFound()) : rootLayoutAtThisLevel ? DefaultNotFound : undefined;
                ...
                Component: ()=>{
                    ...
                    return /*#__PURE__*/ React.createElement(React.Fragment, null, preloadedFontFiles.map((fontFile)=>{
                        ...
                        return /*#__PURE__*/ React.createElement("link", {
                            ...
                            precedence: "high",
                            key: index
                        })) : null, /*#__PURE__*/ React.createElement(Component, Object.assign({}, props, parallelRouteComponents, {
         ...
         */ const renderComponentsOnThisLevel = // No further router state available
                ...
                if (!parentRendered && renderComponentsOnThisLevel) {
                    return [
                        ...
                        isPrefetch && !Boolean(loaderTreeToFilter[2].loading) ? null : React.createElement((await createComponentTree(// This ensures flightRouterPath is valid and filters down the tree
                        {
                            createSegmentPath: (child)=>{
