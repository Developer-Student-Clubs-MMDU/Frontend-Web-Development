...
const serializeExpiredCookie = (key, options = {})=>cookie.serialize(key, "", {
        expires: new Date(0),
        path: "/",
        ...options
    });
...
export class Cookies extends Map {
    ...
    set(key, value, options = {}) {
        return super.set(key, cookie.serialize(key, serializeValue(value), normalizeCookieOptions(options)));
    }
