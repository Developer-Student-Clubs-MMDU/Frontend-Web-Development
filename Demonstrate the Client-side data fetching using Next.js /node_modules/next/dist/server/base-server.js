...
class Server {
    ...
    async handleRequest(req, res, parsedUrl) {
        try {
            ...
            if (this.minimalMode && (req.url.endsWith(".rsc") || typeof req.headers["x-matched-path"] === "string" && req.headers["x-matched-path"].endsWith(".rsc"))) {
    ...
    async renderToResponseWithComponents({ req , res , pathname , renderOpts: opts  }, { components , query  }) {
        ...
        if (isAppPath) {
            res.setHeader("vary", "__rsc__, __next_router_state_tree__, __next_router_prefetch__");
        ...
        const isFlightRequest = Boolean(this.serverComponentManifest && req.headers.__rsc__);
        ...
        if (opts.supportsDynamicHTML === true) {
            ...
            const isSupportedDocument = typeof ((ref7 = components.Document) == null ? void 0 : ref7.getInitialProps) !== "function" || // When concurrent features is enabled, the built-in `Document`
        ...
        resolvedUrlPathname = (0, _normalizeLocalePath).normalizeLocalePath((0, _removeTrailingSlash).removeTrailingSlash(resolvedUrlPathname), (ref6 = this.nextConfig.i18n) == null ? void 0 : ref6.locales).pathname;
        ...
        if (!cachedData) {
            ...
            return {
                ...
                body: isDataReq ? _renderResult.default.fromStatic(isAppPath ? cachedData.pageData : JSON.stringify(cachedData.pageData)) : cachedData.html,
                revalidateOptions
            };
        }
    }
