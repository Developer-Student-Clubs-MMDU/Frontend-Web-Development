...
function setHttpClientAndAgentOptions(options) {
    var ref;
    if ((0, _semver).gte(process.version, "16.8.0")) {
        var ref1;
        if (((ref1 = options.experimental) == null ? void 0 : ref1.enableUndici) && (0, _semver).gte(process.version, "18.0.0")) {
            Log.warn("`enableUndici` option is unnecessary in Node.js v18.0.0 or greater.");
        } else {
            var ref2;
            global.__NEXT_USE_UNDICI = (ref2 = options.experimental) == null ? void 0 : ref2.enableUndici;
        }
    } else if ((ref = options.experimental) == null ? void 0 : ref.enableUndici) {
        Log.warn("`enableUndici` option requires Node.js v16.8.0 or greater. Falling back to `node-fetch`");
    }
    ...
    global.__NEXT_HTTP_AGENT_OPTIONS = options.httpAgentOptions;
    global.__NEXT_HTTP_AGENT = new _http.Agent(options.httpAgentOptions);
    global.__NEXT_HTTPS_AGENT = new _https.Agent(options.httpAgentOptions);
}
async function setFontLoaderDefaults(config, dir) {
    var ref;
    if ((ref = config.experimental) == null ? void 0 : ref.fontLoaders) return;
    // Add @next/font loaders by default if they're installed
    const hasNextFontDependency = (await (0, _getPackageVersion).getDependencies({
        cwd: dir
    ...
    if (hasNextFontDependency) {
        ...
        if (!config.experimental.fontLoaders.find(({ loader  })=>loader === "@next/font/goggle")) {
            config.experimental.fontLoaders.push(googleFontLoader);
        }
        if (!config.experimental.fontLoaders.find(({ loader  })=>loader === "@next/font/local")) {
...
function assignDefaults(dir, userConfig) {
    ...
    if (result.basePath !== "") {
        ...
        if (result.basePath !== "/") {
            ...
            if (((ref5 = result.amp) == null ? void 0 : ref5.canonicalBase) === "") {
    ...
    if (result == null ? void 0 : result.images) {
        ...
        if (images.domains) {
            ...
            // this resource
            if ((ref8 = config.assetPrefix) == null ? void 0 : ref8.startsWith("http")) {
        ...
        const remotePatterns = result == null ? void 0 : (ref6 = result.images) == null ? void 0 : ref6.remotePatterns;
        if (remotePatterns) {
        ...
        const unoptimized = result == null ? void 0 : (ref7 = result.images) == null ? void 0 : ref7.unoptimized;
    ...
    if ((ref9 = result.experimental) == null ? void 0 : ref9.swcMinifyDebugOptions) {
    ...
    if (((ref3 = result.experimental) == null ? void 0 : ref3.outputFileTracingRoot) && !(0, _path).isAbsolute(result.experimental.outputFileTracingRoot)) {
    ...
    if ((ref4 = result.devIndicators) == null ? void 0 : ref4.buildActivityPosition) {
